    ...
    >
      ...
      <ul class="list-style-none me-auto flex flex-col ps-0 lg:flex-row">
        <li class="mb-4 lg:mb-0 lg:pe-2">
          <a class="text-black/60 transition duration-200 hover:text-black/80 focus:text-black/80 dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 lg:px-2" href="#">Dashboard</a>
        </li>
        <li class="mb-4 lg:mb-0 lg:pe-2">
          <a class="text-black/60 transition duration-200 hover:text-black/80 focus:text-black/80 dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 lg:px-2" href="#">Team</a>
        </li>
        <li class="mb-4 lg:mb-0 lg:pe-2">
          <a class="text-black/60 transition duration-200 hover:text-black/80 focus:text-black/80 dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 lg:px-2" href="#">Projects</a>
        </li>
      </ul>
    </div>
